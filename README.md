...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/demes-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12539&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/demes-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `demes` can be installed with:

```
conda install demes
```

It is possible to list all of the versions of `demes` available on your platform with:
